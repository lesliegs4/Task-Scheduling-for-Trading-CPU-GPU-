...
"""
Script simulates price paths of USDJPY bid prices with a Geometric Brownian Motion equation
parameters are estimated from historical log returns of historical bid price data (usdjpy-m1-bid-2013.csv)
...
Si = price at time t
dt = time step
dWi = standard Brownian motion increment ~ N(0, dt)

"""


# Load data
df = pd.read_csv("usdjpy-m1-bid-2013.csv", parse_dates=["timestamp"]) # one month of data 
